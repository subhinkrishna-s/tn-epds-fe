...
import AlertImg from '../../assets/alerts.svg'
...
function SuperAdminDashboard() {
  ...
  return (
    <div className='bg-light py-5' style={{minHeight: '90vh'}}>
        ...
        {
            Cards.map((card, i)=>(
                <div className='col-11 col-sm-10 col-md-5 col-lg-3 border rounded text-center p-2 bg-white' style={{filter: 'drop-shadow(0 0 4px rgb(199, 211, 194))'}} key={i}>
